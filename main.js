...
$(document).ready(function () {
    ...
    function checkWin() {
        ...
        // If there's a win, return true; otherwise, return false
    }

    // Function to check draw condition
    function checkDraw() {
        // Your draw condition logic here
        // If it's a draw, return true; otherwise, return false
    }

    // Function to play winning sound
    function playWinningSound() {
        var winningSound = new Audio('audio/winning.mp3'); // Replace 'path/to/winning_sound.mp3' with the actual path to your winning sound file
        winningSound.play();
    }

    // Function to play drawing sound
    function playDrawingSound() {
        var drawingSound = new Audio('audio/draw.mp3'); // Replace 'path/to/drawing_sound.mp3' with the actual path to your drawing sound file
        drawingSound.play();
    }
